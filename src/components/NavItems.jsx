...
const NavItems = ({ itemName, toUrl }) => {
  return (
    ...
    >
      <p className="relative transition-all w-full h-full duration-300  px-4 py-2 ">
        {itemName}
      </p>
    </NavLink>
  );
